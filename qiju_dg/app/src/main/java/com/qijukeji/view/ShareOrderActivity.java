...
public class ShareOrderActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        companyidnew = preferences.getString("companyid", "");
        tenantUuidnew = preferences.getString("tenantUuid", "");
    ...
    public void ShareBtn() {
        ...
        try {
            ...
            jsonObject.put("tenantUuidnew", tenantUuidnew);
            jsonObject.put("companyidnew", companyidnew);
            jsonObject.put("companyid", companyid);
            jsonObject.put("companyname", gsmc);
