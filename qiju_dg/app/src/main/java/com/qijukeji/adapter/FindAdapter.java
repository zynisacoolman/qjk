...
//        int pernum = numnow / find_info.getUpperLimit();
        ...
        holder.find_rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UmengShareUtils.shareActionOpen(context, activity, staffid, find_info.getUuid(), find_info.getTitle(), find_info.getDescription(), find_info.getShareImage(), staffUuid);
            }
        });
        return convertView;
    }
